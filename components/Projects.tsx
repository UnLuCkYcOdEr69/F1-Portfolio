...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      category: "ML/AI",
      image: `${BASE}house-price-prediction.png`,
    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
        <div>
          ...
          <p className="text-neutral-500 rajdhani tracking-widest max-w-md">
            PROTOTYPES AND DEPLOYED CHASSIS OPTIMIZED FOR COMPETITION.
          </p>
        </div>
        ...
        <div className="flex bg-neutral-900 p-1 border border-neutral-800">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 f1-font text-[10px] transition-all ${
                filter === cat
            ...
            >
              <div className="aspect-video relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-[2px]">
                  <p className="text-sm rajdhani text-neutral-300 mb-4 line-clamp-2">
                    {project.description}
                  </p>
              ...
              <div className="p-6 flex justify-between items-center border-t border-neutral-800">
                <div>
                  <h3 className="text-xl font-black italic f1-font mb-2">
                    {project.title}
                  </h3>
                  <div className="flex gap-2">
                    {project.stack.map(s => (
                      <span
                        key={s}
                        className="text-[10px] rajdhani font-bold px-2 py-0.5 bg-neutral-800 text-neutral-400 uppercase"
                      >
                        {s}
                      </span>
                    ))}
